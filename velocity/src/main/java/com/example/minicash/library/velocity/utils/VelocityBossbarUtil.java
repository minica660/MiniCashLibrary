package com.example.minicash.library.velocity.utils;
...
public class VelocityBossbarUtil implements CustomBossbar {

    private final Player player;
    private final BossBar bossBar;

    public VelocityBossbarUtil(Player player, String title, BossBarColor color, BossBarStyle style) {
        this.player = player;
